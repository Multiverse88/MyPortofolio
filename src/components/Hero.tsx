                ...
                <motion.div className="text-center space-y-6">
                  ...
                  >
                    ...
                    <div className="w-32 h-32 mx-auto">
                      <div
                        className="w-full h-full rounded-2xl shadow-lg border-4 border-white bg-gradient-to-r from-blue-400 to-purple-500"
                        style={{
                          display: "block",
                          width: "8rem",
                          height: "8rem",
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600 text-sm max-w-xs mx-auto">
                      Turning ideas into beautiful, functional digital
                      experiences
                    </p>
